...
if __name__ == '__main__':
    ...
    # basic params
    parser.add_argument('--model_path', type=str, default= "/home/xujg/code/rknn_model_zoo-main/examples/yolov5/model/20240514.onnx", help='model path, could be .pt or .rknn file')
    parser.add_argument('--target', type=str, default='rk3566', help='target RKNPU platform')
    parser.add_argument('--device_id', type=str, default=None, help='device id')
    
    parser.add_argument('--img_show', action='store_true', default=False, help='draw the result and show')
    parser.add_argument('--img_save', type=bool, default=True, help='save the result')
    ...
    parser.add_argument('--anchors', type=str, default='/home/xujg/code/rknn_model_zoo-main/examples/yolov5/model/anchors_yolov5.txt', help='target to anchor file, only yolov5, yolov7 need this param')
